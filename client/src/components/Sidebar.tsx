    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-sidebar-border space-y-3">
          {/* Plan — cosmetic/demo plans page with no real billing. */}
          <Link
            href="/plans"
            onClick={handleNavClick}
            className="flex items-center gap-2 px-2 py-1.5 hover:bg-sidebar-accent rounded-lg transition-all duration-200"
